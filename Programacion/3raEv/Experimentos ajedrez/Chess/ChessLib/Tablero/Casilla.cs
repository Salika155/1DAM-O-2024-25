...
namespace ChessLib.Tablero
{
    ...
    //    private readonly Casilla[,] _buffer;

    //    public int Width => _width;
    //    public int Height => _height;
    //    public Casilla this[int x, int y]
    //    {
    //        get => GetCellAt(x, y);
    ...
    //        _width = width;
    //        _height = height;
    //        _buffer = new Casilla[height, width];
    //    }
    ...
    //    private Casilla GetCellAt(int x, int y)
    //    {
    //        if (x < 0 || x >= _width)
    ...
    //    private void SetCellAt(int x, int y, Casilla value)
    //    {
    //        if (x < 0 || x >= _width)
    //            throw new ArgumentOutOfRangeException("x");
    //        if (y < 0 || y >= _height)
